        ...
        <div class="navbar navbar-default">
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav" id="main-menu">
                ...
                <li class="user-login"><a href="#"><i class="fa fa-align-justify"></i>&nbsp; Makaleler</a></li> 
...
<form action="HocaEkle_Islem.jsp" class="form-group" method="post">
<label>Adı-Soyadı</label>
<div> 
        <input type="text" style="width: 400px; height: 40px;"  class="form-control" id="AdSoyad" name="HocaAdSoyad" required="" />
      
    </div>
 	<label>Kullanıcı Adı</label>
<div> 
        <input type="text" style="width: 400px; height: 40px;" class="form-control" name="HocaKullaniciAdi" required=""/>
      
    </div>
    
    <label>Mail Adresi</label>
<div> 
        <input type="email" style="width: 400px; height: 40px;" class="form-control"  name="HocaMail" placeholder="ornek@gmail.com" required="" />
    </div>
      
     <label>Alanı</label>
    <div> 
   	<select id="KategoriID" name="ktg" style="width: 400px; height: 40px;" >
   		<% 
 ...
 <div style="margin-top:20px">
         <button onclick="successalert()" type="submit" name="save"  class="btn btn-more"><i class="fa fa-check"></i>Ekle</button>
    </div>
   <br>
    <div><label>Kullanıcı Şifre Sistem Tarafından Üretilip Hocaya Gönderilecektir.</label></div>
</form> 
  </div>
          </div>
        </div>

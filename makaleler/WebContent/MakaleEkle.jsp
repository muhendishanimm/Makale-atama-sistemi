...
<label>Başlık</label>
<div> 
        <input type="text" style="width: 600px; height: 40px;"  class="form-control"  name="Baslik" required="" />
      
    </div>
 	<label>İçerik</label>
<div> 
           <textarea type="text" style="width: 600px; height: 400px;" name="Icerik" class="form-control" required=""></textarea>
 ...
 <div style="margin-top:20px">
         <button type="submit" name="save" class="btn btn-more"><i class="fa fa-check"></i>Insert</button>
    </div>

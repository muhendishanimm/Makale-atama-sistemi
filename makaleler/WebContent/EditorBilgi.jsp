...
System.out.println("bu giris yapan id "+ idd);
...
while (rs.next()){
	...
	if(idd==AlinanID){
	KullaniciAdi=rs.getString("EditorKullaniciAdi");
	KullaniciMail=rs.getString("EditorMail");
	Sifre=rs.getString("EditorSifre");
	session.setAttribute("EditorID",idd);
        ...
        <div class="col-sm-6 col-sm-offset-3">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form action="EditorBilgi_Islem.jsp" class="form-group" method="post" accept-charset="UTF-8" role="form">
                <fieldset>
                <div class="form-group">
                    <div class="input-group input-group-lg">
                      <span class="input-group-addon"><i class="fa fa-fw fa-user"></i></span>
                      <input type="text" class="form-control" name="EditorAdSoyad"  value="<%=EditorAd%> "placeholder="Ad Soyad" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group input-group-lg">
                      <span class="input-group-addon"><i class="fa fa-fw fa-user"></i></span>
                      <input type="text" class="form-control" name="EditorKullaniciAdi" value="<%=rs.getString("EditorKullaniciAdi")%> "placeholder="Kullanıcı Adı" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group input-group-lg">
                      <span class="input-group-addon"><i class="fa fa-fw fa-envelope"></i></span>
                      <input type="email" class="form-control" name="EditorMail" value="<%=rs.getString("EditorMail")%> " placeholder="Mail">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group input-group-lg">
                      <span class="input-group-addon"><i class="fa fa-fw fa-lock"></i></span>
                      <input type="password" class="form-control" name="EditorSifre" placeholder="Şifre">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group input-group-lg">

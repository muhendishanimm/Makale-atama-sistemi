...
//seçilen makaleyi aldım makalenin kategorisini aldım   
   ...
   String Durum,MakaleninTarih,DegerlendirenHoca;
   int KategoriId=0;
   ResultSet rs=sayiCrud.makaleselectdata( MakaleID);
   if (rs.next()){
	   Durum=rs.getString("Durum");
	   MakaleninTarih=rs.getString("Tarih");
         	      ...
         	      sayiNesnesi.setTarih(Tarih);
         	  	 ...
         	  	 if (islemSonucu==true){
         	  		 ...
         	  		 String pozisyon="Hakem";
         	  			...
         	  			boolean islemSonucuu=sayiCrud.hocapozisyonguncelle(sayiNesnesi,gHocaID);

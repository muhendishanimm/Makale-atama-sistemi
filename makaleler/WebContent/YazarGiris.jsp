        ...
        <div class="col-sm-6 col-sm-offset-3">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form action="YazarGiris_Islem.jsp" class="form-group" method="post" accept-charset="UTF-8" role="form">
                <fieldset>
               ...
               <p class="m-b-0 m-t">Şifrenizi Mi Unuttunuz? <a href="YazarSifremiUnuttum.jsp">Şifre Gönder</a>.</p>
              <p class="m-b-0 m-t">Sizde Makale Yazmak İster Misiniz? <a href="YazarKayitOl.jsp">Hemen Kayit Olabilirsiniz</a>.</p>
            </div>
          </div>
        </div>
      </div>

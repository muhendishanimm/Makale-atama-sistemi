        ...
        <div class="col-sm-6 col-sm-offset-3">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <form action="HocaBilgi_Islem.jsp" class="form-group" method="post" accept-charset="UTF-8" role="form">
                <fieldset>
                <div class="form-group">
                    <div class="input-group input-group-lg">
                      <span class="input-group-addon"><i class="fa fa-fw fa-user"></i></span>
                      <input type="text" class="form-control" name="HocaAdSoyad"  value="<%=HocaAd%> "placeholder="Ad Soyad" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group input-group-lg">
                  ...
                  <div class="form-group">
                    <div class="input-group input-group-lg">
                      ...
                      <input type="email" class="form-control" name="HocaMail" value="<%=rs.getString("HocaMail")%> " placeholder="Mail">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group input-group-lg">
